...
<h2 class="mt-3">Atualizar ClienteCliente</h2>
...
<form action="edit.php?id=<?php echo $customer['id']; ?>" method="post"> 
  ...
  <div class="row">
    ...
    <div class="form-group col-md-3">
      ...
      <input type="text" class="form-control" id="cpf_cnpj" name="customer['cpf_cnpj'] " maxlength="15" value="<?php echo $customer['cpf_cnpj']; ?>">
    </div>

    <div class="form-group col-md-2">
      <label for="birthdate">Data de Nascimento</label>
      <input type="date" class="form-control" id="birthdate" name="customer['birthdate'] " value="<?php echo formatdata($customer['birthdate'], "d/m/Y"); ?>">
    </div>
  </div>
  ...
  <div class="row">
    ...
    <div class="form-group col-md-2">
      ...
      <input type="date" class="form-control" id="created"  name="customer['created']" disabled value="<?php echo formatdata($customer['created'], "d/m/Y - H:i:s"); ?>">
    </div>
  </div>
  ...
  <div class="row">
    ...
    <div class="form-group col-md-1">
      ...
      <input type="text" class="form-control" id="state" name="customer['state'] " maxlength="2" value="<?php echo $customer['state']; ?>">
    </div>
