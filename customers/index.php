...
<header>
    <div class="row">
        ...
        <div class="col-sm-6 text-end h2">
            <a class="btn btn-secondary mt-3" href="add.php"><i class="fa-solid fa-user-plus"></i> Novo Cliente</a>
            <a class="btn btn-light mt-3" href="index.php"><i class="fa fa-refresh "></i> Atualizar</a>
        </div>
    </div>
</header>
